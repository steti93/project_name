...
<div class="login-box">
    <div class="login-logo">
        <a href="http://uniweb.md"><b>UNIWEB.MD</b></a>
    </div><!-- /.login-logo -->
    <div class="login-box-body">
        {!! Form::open() !!}

        <div class="form-group has-feedback">
            <input type="email" name="email" class="form-control" placeholder="{{ trans('trans.email') }}">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
            <input type="password"  name="password" class="form-control" placeholder="{{ trans('register.password') }}">
